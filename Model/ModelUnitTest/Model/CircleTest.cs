...
namespace ModelUnitTest.Model
{
    ...
    public class CircleTest
    {
        ...
        [TestCase(-1,/*ExpectedException = typeof(FormatException),*/ TestName = "Тестирование площади при радиусе = -1")]
        [TestCase(double.MaxValue, TestName = "Тестировние площади при радиусе =  Double MaxValue")]
        [TestCase(double.MinValue,/*ExpectedException = typeof(FormatException), */TestName = "Тестирование площади при радиусе = double MinValue")]
        [TestCase(double.NaN,  TestName = "Тестирование площади при радиусе = NaN")]
        [TestCase(double.NegativeInfinity,  "Тестирование площади при радиусе = -Inf")]
        [TestCase(double.PositiveInfinity,  "Тестирование площади при радиусе = +Inf")]
