...
namespace ModelUnitTest.Model
{
    ...
    public class TriangleTest
    {
        ...
        [TestCase(5, -7,/*ExpectedException = typeof(FormatException),*/ TestName = "Тестирование площади при основании = 5, (ошибка)высоте = -7")]

        [TestCase(-7, 5,/*ExpectedException = typeof(FormatException),*/ TestName = "Тестирование площади при (ошибка)основании = -7, высоте = 5")]

        [TestCase(-1, -7,/*ExpectedException = typeof(FormatException),*/ TestName = "Тестирование площади при (ошибка)основании = -1, (ошибка)высоте = -7")]

        [TestCase(double.MaxValue, double.MaxValue, /*ExpectedException = typeof(FormatException), */
            TestName = "Тестировние площади при основании = double.MaxValue, высоте = double.MaxValue")]
        ...
        [TestCase(double.PositiveInfinity, double.NegativeInfinity, /*ExpectedException = typeof(FormatException), */
            TestName = "Тестирование площади при основании = +Inf, (ошибка)высоте = -Inf")]

        [TestCase(double.PositiveInfinity, double.PositiveInfinity,/*ExpectedException = typeof(FormatException), */
